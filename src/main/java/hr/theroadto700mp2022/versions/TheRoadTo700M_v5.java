...
public class TheRoadTo700M_v5 {
 ...
 /*
        ...
        //add a picture to me
        me.setIcon(new ImageIcon(TheRoadTo700M_v5.class.getResource("/myhead.jpg")));
        ...
        contractOffer.setIcon(new ImageIcon(TheRoadTo700M_v5.class.getResource("/dollarstash.jpg")));
        ...
        me.addMouseListener(new MeMouseListener_v5(/*new code*/screen,me,contractOffer));
        /*new code*/ me.addMouseMotionListener(new MeMouseListener_v5(/*new code*/screen,me,contractOffer));
        ...
        bgImage.setIcon(new ImageIcon(TheRoadTo700M_v5.class.getResource("/ek.jpeg")));
        ...
        (new ContractOfferGenerator_v5(myPossibilities, contractOffer)).start();

    }
}

class ContractOfferGenerator_v5 extends Thread {
     ...
     * reference
     */
    ContractOfferGenerator_v5(JFrame anyJFrame2, JLabel contractOffer2) {
    ...
    public void run() {
        ...
        (new ContractOfferGenerator_v5(anyJFrame1, contractOffer1)).start();
    }

}

class MeMouseListener_v5 implements MouseListener/*new code*/,MouseMotionListener{
    Border former;
    ...
    MeMouseListener_v5(JLabel screen2, JLabel me2, JLabel contractOffer2){
        screen1 = screen2;
        me1 = me2;
        contractOffer1=contractOffer2;
    }
