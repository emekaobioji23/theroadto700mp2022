...
public class TheRoadTo700M_v4 {
    ...
    public static void main(String[] args) {
        ...
        //add a picture to me
        me.setIcon(new ImageIcon(TheRoadTo700M_v4.class.getResource("/myhead.jpg")));
        ...
        contractOffer.setIcon(new ImageIcon(TheRoadTo700M_v4.class.getResource("/dollarstash.jpg")));
        ...
        me.addMouseListener(new MeMouseListener_v4(/*new code*/myPossibilities,me,contractOffer));
        /*new code*/ me.addMouseMotionListener(new MeMouseListener_v4(/*new code*/myPossibilities,me,contractOffer));

        //let the window appear on the screen
        myPossibilities.setVisible(true);
        
        //new code
        /*myScoreBoard is where the balance of money hunted for is kept
         * 
         */
        //create a ContractGenerator which will keep placing contracts on the screen
        (new ContractOfferGenerator_v4(myPossibilities, contractOffer)).start();

    }
}

class ContractOfferGenerator_v4 extends Thread {
     ...
     * reference
     */
    ContractOfferGenerator_v4(JFrame anyJFrame2, JLabel contractOffer2) {
    ...
    public void run() {
        ...
        (new ContractOfferGenerator_v4(anyJFrame1, contractOffer1)).start();
    }

}

class MeMouseListener_v4 implements MouseListener/*new code*/,MouseMotionListener{
    Border former;
    ...
    MeMouseListener_v4(JFrame anyJFrame2, JLabel me2, JLabel contractOffer2){
        anyJFrame1 = anyJFrame2;
        me1 = me2;
        contractOffer1=contractOffer2;
    }
    ...
    public void mouseDragged(MouseEvent e){
        ...
        //updat me1 position to that of mouse
        me1.setLocation(p);
        if(contractOffer1.getLocationOnScreen().equals(p)){
            System.out.println("hoooooooooooooooray");
        }
    }
}